...
class EndToEndMapBeliefConfig(BaseE2EArchConfig):
    ...
    def to_e2e_config(self):
        ...
        from .end_to_end.end_to_end_map_belief_transformer import E2EConfig
        return E2EConfig(
...
class PatchBoreholeEndToEndConfig(BaseE2EArchConfig):
    ...
    def to_patch_config(self):
        ...
        from .end_to_end.patch_borehole_transformer import PatchBoreholeConfig
...
class PatchBoreholeCLSEndToEndConfig(BaseE2EArchConfig):
    ...
    def to_cls_config(self):
        ...
        from .end_to_end.patch_borehole_cls_transformer import PatchBoreholeCLSConfig
...
class VariableAwarePatchBoreholeEndToEndConfig(BaseE2EArchConfig):
    ...
    def to_encoder_config(self):
        ...
        from .end_to_end.variable_aware_patch_borehole_transformer import VariableAwarePatchBoreholeConfig
