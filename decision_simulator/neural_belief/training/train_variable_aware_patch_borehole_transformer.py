...
@dataclass
class VariableAwarePatchBoreholeE2ETrainingConfig:
    ...
    # Spatial grid — set automatically from cache in train_variable_aware_patch_borehole_transformer()
    n_x: int = 32
    n_y: int = 32
...
def train_variable_aware_patch_borehole_transformer(
    ...
    cfg: VariableAwarePatchBoreholeE2ETrainingConfig,
    device: str,
    checkpoint_dir: Path,
    ...
    save_checkpoint_model(
        checkpoint_dir / "variable_aware_patch_last.pt",
        model,
        cfg,
        epoch,
        history,
...
def load_variable_aware_patch_borehole_checkpoint(
    ...
    return load_model_encoder_checkpoint(
        path, _model_fn, VariableAwarePatchBoreholeE2ETrainingConfig, device
    )
